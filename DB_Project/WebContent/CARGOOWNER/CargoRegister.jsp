...
<html>
	...
	<%
		...
		System.out.println("selectCargoOwnerId : " + selectCargoOwnerId);
		while(rs.next())
		{
			cargoOwnerId = rs.getString("cargoOwnerId");
			if(cargoOwnerId.equals(selectCargoOwnerId))
			{
	...
	<center>
		<h2>화물 등록</h2> 
		<form action="CargoRegisterCheck.jsp" method="post">
			<table>
			<tr>
				<td>목적지행성ID</td>
				<td><input type="text" name="planetId" /></td>
			</tr>
			<tr>
				<td>화물명</td>
